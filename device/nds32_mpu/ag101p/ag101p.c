...
#define NTC0_CACHEABILITY       CACHE_MODE
#ifdef CFG_XIP
#define NTC2_CACHEABILITY       CACHE_MODE
#else
#define NTC2_CACHEABILITY       CACHE_NONE
#endif
#else
/* Uncacheable */
#define NTC0_CACHEABILITY       CACHE_NONE
#define NTC2_CACHEABILITY       CACHE_NONE
#endif
 ...
 * NTC0: CACHE_MODE
 * NTC1: Non-cacheable
 * NTC2: CACHE_MODE (in XIP mode) or Non-cacheable
 * NTC3: Non-cacheable
 * NTM3 mapped to partition 2 for Non-cacheable I/O in XIP mode
 */
#define MMU_CTL_INIT                                    \
        (0x0UL << MMU_CTL_offD                          \
         | (NTC0_CACHEABILITY) << MMU_CTL_offNTC0       \
         | 0x0UL << MMU_CTL_offNTC1                     \
         | (NTC2_CACHEABILITY) << MMU_CTL_offNTC2       \
...
static void mmu_init(void)
{
	...
	/* Peripherial region : 0x80000000 ~ 0x9FFFFFFF */
	vPortSetupMPU(4);
}
...
/*
 * All AG101P system initialization
 */
